...
interface InsidentalTableSectionProps {
  initialData: PengajuanDanaItem[];
}

export function InsidentalTableSection({ initialData }: InsidentalTableSectionProps) {
    ...
    <>
      <MasterDataTableShell<PengajuanDanaItem>
        ...
        toolbarProps={{
          ...
          onRefresh: () => alert("Memperbarui data Insidental..."),
          onAddNew: () => router.push("/pengajuan/create?type=insidental"),
        }}
      />
