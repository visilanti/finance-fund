...
interface JaldisTableSectionProps {
...
export function JaldisTableSection({ initialData }: JaldisTableSectionProps) {
  ...
  const filteredData = useMemo(() => {
    return initialData.filter((item) => {
      const matchType = item.jenis === "Perjalanan";
  ...
  return (
    <>
      <MasterDataTableShell<PengajuanDanaItem>
        ...
        toolbarProps={{
          searchPlaceholder: "Cari di Kwitansi Perjalanan Dinas...",
          statusFilter,
          ...
          onExport: () => alert("Exporting data Perjalanan Dinas..."),
          onRefresh: () => alert("Memperbarui data Perjalanan Dinas..."),
          onAddNew: () => router.push("/pengajuan/create?type=jaldis"),
        }}
      />
